# Lab 1 - Privileged Accounts

## Lab 1.1 - Create separated accounts for privileged access by Identity Provisioning

TBD

## Lab 1.2 - Link privileged account to identity in Microsoft Defender XDR
...
## Lab 1.3 - Assign privileged account to Restricted Management Administrative Unit (RMAU)
